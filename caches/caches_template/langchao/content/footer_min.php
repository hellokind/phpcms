<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?><div id="footer">
    <div id="dbnews">
        <div class="dbnews">经营许可证编号：京ICP证090533号&nbsp;&nbsp;
            国新办网备字[2006]7号&nbsp;&nbsp;
            广播电视节目制作经营许可证:(京)字第02592号&nbsp;&nbsp;京公网安备11010102001756号<br>
...
<div id="rsig" style="left: 749px; display: block; visibility: visible;">
    <div class="r">
        <a class="gotop" href="#"></a><a class="sina" id="s" href="#"></a><a class="weixin" id="w" href="#"></a>
        <div class="tanw" id="tanw"></div>
    </div>
</div>
...
<script type="text/javascript" src="<?php echo JS_PATH;?>Scripts/n.js"></script>
<script type="text/javascript" src="<?php echo JS_PATH;?>Scripts/m.js"></script>
<!-- footer end -->
